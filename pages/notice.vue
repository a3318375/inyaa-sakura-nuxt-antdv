...
<template>
  ...
  <div class="pt-16">
    <div class="fixed left-0 w-1/2 h-full bg-white bg-opacity-80" aria-hidden="true" />
    <div class="fixed right-0 w-1/2 h-full bg-white bg-opacity-80" aria-hidden="true" />
        ...
        <div class="flex-1 min-w-0 xl:flex">
            ...
            <div class="pl-4 pr-6 pt-4 pb-4 border-b border-t border-gray-200 sm:pl-6 lg:pl-8 xl:pl-6 xl:pt-6 xl:border-t-0">
                ...
                <Menu as="div" class="relative">
                    <MenuButton class="w-full bg-white bg-opacity-80 border border-gray-300 rounded-md shadow-sm px-4 py-2 inline-flex justify-center text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    ...
                    <MenuItems class="origin-top-right z-10 absolute right-0 mt-2 w-56 rounded-md shadow-lg bg-white bg-opacity-80 ring-1 ring-black ring-opacity-5 focus:outline-none">
                    <div class="py-1">
